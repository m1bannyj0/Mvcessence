...
INSERT INTO `essences` (`id`, `name`, `surname`, `gender`, `group_number`, `email`, `exam_score`, `birth_year`, `residence`, `hash`) VALUES
...
--
-- AUTO_INCREMENT for table `essences`
--
ALTER TABLE `essences`
